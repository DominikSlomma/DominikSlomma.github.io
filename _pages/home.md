...
My current research focuses on deformable 3D reconstruction and visual SLAM for surgical robotics, where perception must remain robust in changing, non-rigid environments.

More broadly, I am interested in 360-degree perception, dense mapping, AI-supported situational awareness, and real-time computer vision for robotic systems that need to work under practical hardware and field constraints.

Across these topics, I am especially interested in the step from research prototype to deployable robotic system: how algorithms, sensors, computation, and user needs come together in real environments.

## Experience Highlights

- UAV examiner and instructor for the German Rescue Robotics Center
- Supervision of Master thesis, Bachelor theses, and research interns
- Robotics Task Force deployments during a major industrial fire in Berlin and the Erftstadt/Blessem flood disaster
- AI-based fire and object detection, 2D/3D mapping workflows, and interactive panorama-viewer projects for emergency-response robotics
- Automotive real-time control-unit testing, exhaust aftertreatment validation, and hardware-in-the-loop test environments

## Latest News
{% include news-list.html limit=3 show_read_more=true %}

<p style="margin-top: 20px;">
  <a class="btn btn-outline-primary" href="{{ '/projects/' | relative_url }}">Explore research projects</a>
</p>
